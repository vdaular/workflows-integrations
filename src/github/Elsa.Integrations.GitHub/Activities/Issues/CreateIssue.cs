...
namespace Elsa.Integrations.GitHub.Activities.Issues;
...
public class CreateIssue : GitHubActivity
{
    ...
    public Input<IEnumerable<string>?> Labels { get; set; } = default!;
    ...
    public Input<IEnumerable<string>?> Assignees { get; set; } = default!;

    /// <summary>
    /// The created issue.
    /// </summary>
    [Output(Description = "The created issue.")]
    public Output<Issue> CreatedIssue { get; set; } = default!;
