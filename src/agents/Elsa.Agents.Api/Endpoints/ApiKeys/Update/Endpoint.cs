...
/// </summary>
[UsedImplicitly]
public class Endpoint(IApiKeyStore store) : ElsaEndpoint<ApiKeyModel, ApiKeyDefinition>
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    public override async Task<ApiKeyDefinition> ExecuteAsync(ApiKeyModel req, CancellationToken ct)
    {
